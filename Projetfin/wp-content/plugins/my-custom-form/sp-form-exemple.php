...
*/
    ...
    function html_form_code(){
        ...
        echo '<p>';
        echo "<span style='color : black;'>Votre Email<span style ='color : red;'>*</span><br />";
        echo '<input type="email" name="cf-email" value="' . ( isset( $_POST["cf-email"] ) ? esc_attr( $_POST["cf-email"] ) : '' ) . '" size="40" style="height : 40px" />';
        echo '</p>';
        echo '<p>';
        echo "<span style ='color : black;'>Votre Nom <span style ='color : red;'>*</span></span> <br />";
        ...
        echo '</p>';
        echo '<p>';
        echo "<span style='color : black;'>Your Message <span style ='color : red;'>*</span><br />";
    ...
    function deliver_mail() {
        ...
        if ( isset( $_POST['cf-submitted'] ) ) {
            ...
            try {
                ...
                $mail->Username   = 'toureb990@gmail.com';                     //SMTP username
                $mail->Password   = 'ohgnaazxxiildumb';                               //SMTP password
                ...
                //Recipients
                $mail->setFrom('toureb990@gmail.com','Arabe Kalaso');
                $mail->addAddress('toureb42@gmail.com');     //Add a recipient
    ...
    add_shortcode( 'arabe_contact_form', 'cf_shortcode' );
?>